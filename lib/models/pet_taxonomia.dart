...
List<PetTaxonimia> petTaxonimiaFromJson(String str) => List<PetTaxonimia>.from(json.decode(str).map((x) => PetTaxonimia.fromJson(x)));

String petTaxonimiaToJson(List<PetTaxonimia> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
